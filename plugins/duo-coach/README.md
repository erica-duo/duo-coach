...
Minimal Claude Code plugin for Duo clients. Gets their infrastructure stood up — GitHub repo, n8n Cloud, Slack + Notion connected — so Duo can build automations on top.
...
2. Their own n8n Cloud — where automations actually run
...
- **n8n Cloud** — runs all automations, hosts credentials (Slack, Notion, Anthropic)
